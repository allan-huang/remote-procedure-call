...
/**
 * Represents a persistent set of properties for RFC system.
 * 
 * @author Y.C. Huang
 */
public class RfcProperties extends Properties {
	private static final Logger log = LoggerFactory.getLogger(RfcProperties.class);
	 ...
	 */
	public RfcProperties(String propertyFilePath) {
		super();

		URL propFileUrl = RfcProperties.class.getResource(propertyFilePath);
		if (propFileUrl != null) {
		...
		InputStream propFileIn = RfcProperties.class.getResourceAsStream(this.propertyFilePath);
		try {
