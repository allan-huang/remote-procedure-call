...
public class ChannelProxy {
	 ...
	 * @throws RfcException if there is no available channel
	 */
	public ResponseFuture<Response> send(Command command) throws RfcException {
		if (false == this.isAvailable()) {
			RfcException error = new ClientSideException("This channel proxy is unavailable. channel proxy: " + this);
	 ...
	 * @throws RfcException if the corresponding response future can't be found.
	 */
	public void receive(Response response) throws RfcException {
