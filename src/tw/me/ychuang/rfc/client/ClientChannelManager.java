...
import tw.me.ychuang.rfc.Constants.ChannelSelectionType;
...
public class ClientChannelManager {
	 ...
	 */
	public ChannelProxy selectChannelProxy() throws RfcException {
		ClientProperties propertyLoader = ClientProperties.getInstance();
	 ...
	 * @throws RfcException if there is no available channel.
	 */
	private ChannelProxy selectChannelProxyByRoundRobin() throws RfcException {
	 ...
	 * @throws RfcException if there is no available channel.
	 */
	private ChannelProxy selectChannelProxyByWorkload() throws RfcException {
