...
/**
 * Performance measurement tool in client-side.
 * 
 * @author Y.C. Huang
 */
public class ClientMeasurer {
	private static final Logger log = LoggerFactory.getLogger(ClientMeasurer.class);
	...
	public static void showStatistics() {
		...
		log.info("Client-side measurement in millisecond, total exec count: {}, avg exec time: {}, max exec time: {}, min exec time: {}", execCounter,
