...
import tw.me.ychuang.rfc.server.ServerMeasurer;
...
public class Simulator {
	...
	private static final String PROPERTY_FILE_PATH = "/rfc-simulator.properties";
	...
	private static RfcProperties propertyLoader;
	...
	public static void main(String[] args) throws Exception {
		...
		RfcProperties propertyLoader = new RfcProperties(PROPERTY_FILE_PATH);
